...
# port = '/dev/cu.usbmodem14341' # For real arduinos on Tobin's New Mac
...
testMoveList = [[(7, 8), (6.5, 8.5)], [(8, 8), (7, 8), (6, 7)], [(6.5, 8.5), (7, 8)]]
...
splitMove(testMoveList)

while True:
    # print (ser.readline())
    if isMoving:
        print ("The system is moving")
    else: 
        print ("Not moving")
